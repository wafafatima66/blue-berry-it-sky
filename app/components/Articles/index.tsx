...
const postData: DataType[] = [
    {
        ...
        heading2: 'Protect data and systems in 2025',
        name: "Blue Berry IT Sky",
        date: 'Nov 2025',
    ...
    {
        time: "7 min",
        heading: 'Modern AI Development',
        heading2: 'Prototype to production',
        name: "Blue Berry IT Sky",
        date: 'Nov 2025',
    ...
    },
    {
        ...
        heading2: 'Tools, memory and safety',
        name: "Blue Berry IT Sky",
        date: 'Nov 2025',
                            ...
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    ...
                                    <Link href={`/blog/${items.slug}`}>
                                        <h3 className="absolute bg-red text-white hover:bg-darkred hover:shadow-xl py-3 px-6 rounded-full article-img">{items.time} read</h3>
                                    </Link>
