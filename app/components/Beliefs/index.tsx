    ...
    return (
        <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl'>
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16 mx-5 gap-5'>
                ...
                <div className="bg-blue bg-beliefs pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    <h2 className="text-lg font-normal text-white tracking-widest mb-5 text-center sm:text-start">BELIEFS</h2>
                    <h3 className="text-4xl sm:text-65xl font-bold text-white leading-snug mb-5 text-center sm:text-start">Honesty <span className="text-black">and hard work are our beliefs.</span></h3>
                ...
                <div className="bg-build pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    ...
                    <div className="text-center sm:text-start">
                        <a href="#services-section" className="inline-block text-xl py-5 px-14 mt-5 font-semibold text-white rounded-full bg-red border border-red hover:bg-darkred">Learn more</a>
                    </div>
                </div>
