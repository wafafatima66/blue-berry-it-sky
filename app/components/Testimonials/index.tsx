...
const postData: DataType[] = [
    {
        name: 'CEO',
        profession: 'E-Commerce Platform',
        comment: "Blueberry IT Sky transformed our outdated system into a modern, scalable platform. The team was professional, responsive, and delivered ahead of schedule.",
        imgSrc: '/images/testimonial/user1.svg',
    },
    {
        name: 'Founder',
        profession: 'FinTech Startup',
        comment: "Working with Blueberry IT Sky was seamless. They understood our requirements immediately and provided solutions that exceeded expectations. Highly recommended!",
        imgSrc: '/images/testimonial/user2.svg',
    },
    {
        name: 'CTO',
        profession: 'Manufacturing Company',
        comment: "The level of expertise and attention to detail is impressive. They didn't just build what we asked for—they optimized it and taught us best practices.",
            ...
            <div className="bg-testimonial pt-40 pb-32 lg:py-32" id="testimonial-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-4xl sm:text-6xl font-bold text-black my-24">See what others are saying.</h3>
